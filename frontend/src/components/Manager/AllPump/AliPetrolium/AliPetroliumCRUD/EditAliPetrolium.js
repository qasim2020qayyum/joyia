  ...
  //   const [data, setData] = useState([]);
    ...
    const params = useParams();
      ...
      const getUserDetail = async() =>{
          let res = await fetch(`http://localhost:8000/joiya/pump/data/${params.id}`)
          res = await res.json();
    ...
    const updateData = async(e) =>{
     ...
     let res = await fetch(`http://localhost:8000/joiya/pump/data/${params.id}`,{
      method: "put",
      body: JSON.stringify({lastReadingSup1, lastReadingSup2, lastReadingSup3, lastReadingSup4,lastReadingHsd1,lastReadingHsd2,
                            sup1_currentReading,sup2_currentReading,sup3_currentReading,sup4_currentReading,hsd1_currentReading,hsd2_currentReading,
                            psoCard,HBLCard,bankDeposit,lubricants,tucShop,miscPayment,miscOther
                            }),
      headers:{
