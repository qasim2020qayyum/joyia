const Pump = require("../models/jahangirPetroliumService")



exports.addJahangirPetroliumData = async (req, res) => {
...
// get 
exports.getJahangirPetroliumData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getJahangirPetroliumDataa = async (req, res) => {
  try {
...
exports.getJahangirPetroliumDataDetails = async (req, res) => {
...
// update 
exports.updateJahangirPetroliumData = async (req, res) => {
...
// delete
exports.deleteJahangirPetrolium = async (req, res) => {
  // res.send(req.params)
