const Pump = require("../models/nadirFillingStation")



exports.addNadirFillingStationData = async (req, res) => {
  ...
  if (pumpData.length === 0) {
    const {
      // nosels 
      sup1_currentReading, sup2_currentReading, hsd1_currentReading, hsd2_currentReading,hsd3_currentReading,
      ...
      lastReadingSup1, lastReadingSup2, preClosing, lastReadingHsd1, lastReadingHsd2,lastReadingHsd3
    } = req.body;
    ...
    try {
      ...
      let allHsdComSale = comSalehsd1 + comSalehsd2+ comSalehsd3;
      ...
      const newPumpData = new Pump({
        ...
        lastReadingHsd1, lastReadingHsd2,lastReadingHsd3, lastReadingSup1, lastReadingSup2,
        ...
        // computer sale 
        comSaleSup1, comSaleSup2, comSalehsd1, comSalehsd2,comSalehsd3,
...
// get 
exports.getNadirFillingStationData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getNadirFillingStationDataa = async (req, res) => {
  try {
...
exports.getNadirFillingStationDataDetails = async (req, res) => {
...
// update 
exports.updateNadirFillingStationData = async (req, res) => {
  ...
  try {
    ...
    pumpData.allHsdComSale = pumpData.comSalehsd1 + pumpData.comSalehsd2+ pumpData.comSalehsd3
    // sup Sale Amount
...
// delete
exports.deleteNadirFillingStation = async (req, res) => {
  // res.send(req.params)
