const Pump = require("../models/idFillingStation")



exports.addidFillingStationData = async (req, res) => {
  ...
  if (pumpData.length === 0) {
    const {
      // nosels 
      sup1_currentReading, sup2_currentReading, hsd1_currentReading, hsd2_currentReading,hsd3_currentReading,hsd4_currentReading,
      ...
      lastReadingSup1, lastReadingSup2, preClosing, lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4
    } = req.body;
    ...
    try {
      ...
      let allHsdComSale = comSalehsd1 + comSalehsd2+ comSalehsd3 + comSalehsd4;
      ...
      const newPumpData = new Pump({
        ...
        lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4, lastReadingSup1, lastReadingSup2,
        ...
        // computer sale 
        comSaleSup1, comSaleSup2, comSalehsd1, comSalehsd2,comSalehsd3,comSalehsd4,
...
// get 
exports.getidFillingStationData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getidFillingStationDataa = async (req, res) => {
  try {
...
exports.getidFillingStationDataDetails = async (req, res) => {
...
// update 
exports.updateidFillingStationData = async (req, res) => {
  ...
  try {
    ...
    pumpData.allHsdComSale = pumpData.comSalehsd1 + pumpData.comSalehsd2+ pumpData.comSalehsd3+ pumpData.comSalehsd4
    // sup Sale Amount
...
// delete
exports.deleteIdFillingStation = async (req, res) => {
  // res.send(req.params)
