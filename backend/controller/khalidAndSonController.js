const Pump = require("../models/khalidAndSonsPso")



exports.addKhalidAndSonData = async (req, res) => {
...
// get 
exports.getKhalidAndSonData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getKhalidAndSonDataa = async (req, res) => {
  try {
...
exports.getKhalidAndSonDataDetails = async (req, res) => {
...
// update 
exports.updateKhalidAndSonData = async (req, res) => {
...
// delete
exports.deleteKhalidAndSon = async (req, res) => {
  // res.send(req.params)
