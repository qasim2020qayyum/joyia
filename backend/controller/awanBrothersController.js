const Pump = require("../models/awanBrothers")



exports.addAwanBrothersData = async (req, res) => {
  ...
  if (pumpData.length === 0) {
    const {
      // nosels 
      sup1_currentReading, sup2_currentReading, hsd1_currentReading, hsd2_currentReading,hsd3_currentReading,hsd4_currentReading,hsd5_currentReading,hsd6_currentReading,
      ...
      lastReadingSup1, lastReadingSup2, preClosing, lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4,lastReadingHsd5,lastReadingHsd6
    } = req.body;
    ...
    try {
      ...
      let comSalehsd3 = hsd3_currentReading - lastReadingHsd3;
      let comSalehsd4 = hsd4_currentReading - lastReadingHsd4;
      let comSalehsd5 = hsd5_currentReading - lastReadingHsd5;
      let comSalehsd6 = hsd6_currentReading - lastReadingHsd6;

      // sale amount calculations
      let allSupComSale = comSaleSup1 + comSaleSup2;
      let allHsdComSale = comSalehsd1 + comSalehsd2+ comSalehsd3 + comSalehsd4 + comSalehsd5 + comSalehsd6;
      ...
      const newPumpData = new Pump({
        ...
        lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4,lastReadingHsd5,lastReadingHsd6, lastReadingSup1, lastReadingSup2,
        ...
        // computer sale 
        comSaleSup1, comSaleSup2, comSalehsd1, comSalehsd2,comSalehsd3,comSalehsd4,comSalehsd5,comSalehsd6,
    ...
    let lastReadingHsd3 = pumpData[pumpData.length - 1].hsd3_currentReading
    let lastReadingHsd4 = pumpData[pumpData.length - 1].hsd4_currentReading
    let lastReadingHsd5 = pumpData[pumpData.length - 1].hsd5_currentReading
    let lastReadingHsd6 = pumpData[pumpData.length - 1].hsd6_currentReading
...
// get 
exports.getAwanBrothersData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getAwanBrothersDataa = async (req, res) => {
  try {
...
exports.getAwanBrothersDataDetails = async (req, res) => {
...
// update 
exports.updateAwanBrothersData = async (req, res) => {
  ...
  try {
    ...
    pumpData.hsd3_currentReading = req.body.hsd3_currentReading;
    pumpData.hsd4_currentReading = req.body.hsd4_currentReading;
    pumpData.hsd5_currentReading = req.body.hsd5_currentReading;
    pumpData.hsd6_currentReading = req.body.hsd6_currentReading;
    ...
    pumpData.lastReadingHsd3 = PumpResult.lastReadingHsd3
    pumpData.lastReadingHsd4 = PumpResult.lastReadingHsd4
    pumpData.lastReadingHsd5 = PumpResult.lastReadingHsd5
    pumpData.lastReadingHsd6 = PumpResult.lastReadingHsd6
    ...
    pumpData.comSalehsd3 = req.body.hsd3_currentReading - PumpResult.lastReadingHsd3;
    pumpData.comSalehsd4 = req.body.hsd4_currentReading - PumpResult.lastReadingHsd4;
    pumpData.comSalehsd5 = req.body.hsd5_currentReading - PumpResult.lastReadingHsd5;
    pumpData.comSalehsd6 = req.body.hsd6_currentReading - PumpResult.lastReadingHsd6;
    ...
    pumpData.allHsdComSale = pumpData.comSalehsd1 + pumpData.comSalehsd2+ pumpData.comSalehsd3+ pumpData.comSalehsd4+ pumpData.comSalehsd5+ pumpData.comSalehsd6
    // sup Sale Amount
...
// delete
exports.deleteAwanBrothers = async (req, res) => {
  // res.send(req.params)
