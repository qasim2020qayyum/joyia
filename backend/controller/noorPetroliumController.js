const Pump = require("../models/noorPetrolium")



exports.addNoorPetroliumData = async (req, res) => {
...
// get 
exports.getNoorPetroliumData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getNoorPetroliumDataa = async (req, res) => {
  try {
...
exports.getNoorPetroliumDataDetails = async (req, res) => {
...
// update 
exports.updateNoorPetroliumData = async (req, res) => {
...
// delete
exports.deleteNoorPetrolium = async (req, res) => {
  // res.send(req.params)
