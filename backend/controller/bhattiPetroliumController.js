const Pump = require("../models/bhattiPetrolium")



exports.addBhattiPetroliumData = async (req, res) => {
  ...
  if (pumpData.length === 0) {
    const {
      // nosels 
      sup1_currentReading, sup2_currentReading, sup3_currentReading, hsd1_currentReading,
      ...
      // expense 
      miscPayment, miscOther, lastReadingSup1, lastReadingSup2, lastReadingSup3, preClosing, lastReadingHsd1
    } = req.body;
    ...
    try {
      ...
      let allSupComSale = comSaleSup1 + comSaleSup2 + comSaleSup3;
      let allHsdComSale = comSalehsd1;
      ...
      const newPumpData = new Pump({
        ...
        lastReadingHsd1, lastReadingSup1, lastReadingSup2, lastReadingSup3,
        ...
        // computer sale 
        comSaleSup1, comSaleSup2, comSaleSup3, comSalehsd1,
...
// get 
exports.getBhattiPetroliumData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getBhattiPetroliumDataa = async (req, res) => {
  try {
...
exports.getBhattiPetroliumDataDetails = async (req, res) => {
...
// update 
exports.updateBhattiPetroliumData = async (req, res) => {
  ...
  try {
    ...
    pumpData.allSupComSale = pumpData.comSaleSup1 + pumpData.comSaleSup2 + pumpData.comSaleSup3
    pumpData.allHsdComSale = pumpData.comSalehsd1
    // sup Sale Amount
...
// delete
exports.deleteBhattiPetrolium = async (req, res) => {
  // res.send(req.params)
