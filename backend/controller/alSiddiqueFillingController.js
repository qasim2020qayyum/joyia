const Pump = require("../models/alSiddiqueFillingStation")



exports.addAlSiddiqueData = async (req, res) => {
...
// get 
exports.getAlSiddiqueData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getAlSiddiqueDataa = async (req, res) => {
  try {
...
exports.getAlSiddiqueDataDetails = async (req, res) => {
...
// update 
exports.updateAlSiddiqueData = async (req, res) => {
...
// delete
exports.deleteAlSiddique = async (req, res) => {
  // res.send(req.params)
