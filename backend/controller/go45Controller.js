const Pump = require("../models/go45")



exports.addGo45Data = async (req, res) => {
...
// get 
exports.getGo45Data = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getGo45Dataa = async (req, res) => {
  try {
...
exports.getGo45DataDetails = async (req, res) => {
...
// update 
exports.updateGo45Data = async (req, res) => {
...
// delete
exports.deleteGo45 = async (req, res) => {
  // res.send(req.params)
