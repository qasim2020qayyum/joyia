const Pump = require("../models/babaFareedFillingStation")



exports.addbabaFareedData = async (req, res) => {
...
// get 
exports.getbabaFareedData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getbabaFareedDataa = async (req, res) => {
  try {
...
exports.getbabaFareedDataDetails = async (req, res) => {
...
// update 
exports.updatebabaFareedData = async (req, res) => {
...
// delete
exports.deletebabaFareed = async (req, res) => {
  // res.send(req.params)
